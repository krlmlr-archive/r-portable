...
size_mb_vhd_gz <- round(file.info("R.vhd.gz")$size / (2 ** 20), 1)
```
...
- [R.vhd.gz](https://rportable.blob.core.windows.net/r-portable/`r BRANCH`/R.vhd.gz) (`r size_mb_vhd_gz` MB, MD5 hash: ``r MD5_vhd_gz``)
