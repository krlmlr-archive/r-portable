...
- [R.tar.gz](https://rportable.blob.core.windows.net/r-portable/`r BRANCH`/R.tar.gz) (`r format_mb(size_tar_gz)`, MD5 hash: ``r MD5_tar_gz``)
- [R.iso.gz](https://rportable.blob.core.windows.net/r-portable/`r BRANCH`/R.iso.gz) (`r format_mb(size_iso_gz)`, MD5 hash: ``r MD5_iso_gz``)
- [R.vhd.gz](https://rportable.blob.core.windows.net/r-portable/`r BRANCH`/R.vhd.gz) (`r format_mb(size_vhd_gz)`, MD5 hash: ``r MD5_vhd_gz``)
